    ...
    <div className={styles.locationAmenities}>
      ...
      <div className={styles.chart}>
        <div className={styles.model}>
          <div className={styles.simulation}>
            ...
            <div className={styles.template}>
              <div className={styles.weatherInfo}>
                <img className={styles.suncloudIcon} loading="lazy" alt="" />
              ...
              <div className={styles.frameParent}>
                <div className={styles.sunParent}>
                  <img className={styles.sunIcon} alt="" />
              ...
              <div className={styles.frameContainer}>
                <div className={styles.sunContainer}>
                  <img className={styles.sunIcon1} alt="" src="/sun-1.svg" />
              ...
              <div className={styles.frameDiv}>
                <div className={styles.suncloudGroup}>
                  <img className={styles.suncloudIcon2} alt="" />
              ...
              <div className={styles.frameParent1}>
                <div className={styles.suncloudContainer}>
                  <img className={styles.suncloudIcon3} alt="" />
              ...
              <div className={styles.frameParent2}>
                <div className={styles.sunParent1}>
                  <img className={styles.sunIcon2} alt="" src="/sun-1.svg" />
          ...
          <img className={styles.modelChild} alt="" src="/rectangle-1@2x.png" />
          <img className={styles.dataAggregatorIcon} loading="lazy" alt="" />
        </div>
      </div>
    </div>
  );
